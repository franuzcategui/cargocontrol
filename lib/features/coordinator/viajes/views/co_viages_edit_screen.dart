...
import '../widgets/co_carga_edit_widget.dart';
import '../widgets/co_datos_generales_widget.dart';
import '../widgets/co_generales_edit_widget.dart';
import '../widgets/co_tempo_edit_widget.dart';

class CoViajesEditScreen extends StatelessWidget {
  const CoViajesEditScreen({Key? key}) : super(key: key);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Divider(height: 1.h,color: context.textFieldColor,),
                  SizedBox(height: 28.h,),
                  const CoGeneralesEditWidget(),
                  SizedBox(height: 20.h,),
                  Divider(height: 1.h,color: context.textFieldColor,),
                  SizedBox(height: 28.h,),
                  const CoTempoEditWidget(),
                  SizedBox(height: 20.h,),
                  Divider(height: 1.h,color: context.textFieldColor,),
                  SizedBox(height: 28.h,),
                  const CoCargaEditWidget(),
