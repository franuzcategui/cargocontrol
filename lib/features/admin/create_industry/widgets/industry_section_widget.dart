...
class IndustrySectionWidget extends ConsumerStatefulWidget {
  ...
  const IndustrySectionWidget({Key? key, required this.index,  required this.onRemove, required this.comenzoWIdget, required this.endOfGuideWidget, required this.loadWidget, required this.industryNameCtr, required this.productNameCtr}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 8.h,),
        CustomDropDown(ctr: widget.industryNameCtr, list: ref.read(adIndustryNotiController).industryNames, labelText: 'Nombre',),
        SizedBox(height: 10.h,),
        widget.comenzoWIdget,
        SizedBox(height: 10.h,),
        widget.endOfGuideWidget,
        SizedBox(height: 10.h,),
        CustomDropDown(ctr: widget.productNameCtr, list: ref.read(adVesselNotiController).vesselProductNames, labelText: 'Producto (Variedad)',),
