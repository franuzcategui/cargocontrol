...
class AdRecentRecordCard extends StatelessWidget {
  ...
  const AdRecentRecordCard({Key? key, required this.isEntered, required this.isLeaving, required this.driverName, required this.guideNumber, required this.portEntryTime}) : super(key: key);
