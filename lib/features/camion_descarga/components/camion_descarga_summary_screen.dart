...
class CamionDescargaSummaryScreen extends StatelessWidget {
  const CamionDescargaSummaryScreen({super.key});
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          InfoDescription(jsonObject: map, title: 'Información del camion'),
          const Spacer(),
          MainTextButton(
            text: "CONTINUAR",
